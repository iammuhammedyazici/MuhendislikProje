...
<div class="menu">
  ...
  <tr>
    <td colspan="6" align="center" valign="middle"><input name="button" type="submit" id="button" value="Aracı Ekle" /></td>
    </tr>
  </table>
  ...
  <?php 
        ...
        if($_POST){
            ...
            $ekle        =    mysqli_query($baglan,"insert into arackaydı (tc,ad,soyad,a_ad,a_model,a_yil,a_plaka,a_tel,a_posta) values ('$tc','$ad','$soyad','$a_ad','$a_model','$a_yil','$a_plaka','$a_tel','$a_posta')");
